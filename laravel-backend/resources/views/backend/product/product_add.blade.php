           ...
           <div class="border border-3 p-4 rounded">
			<div class="mb-3">
				...
				<input type="text" name="title" class="form-control" id="inputProductTitle" placeholder="Enter product title">
			  	...
			  	<div class="mb-3">			<label for="inputProductTitle" class="form-label">Product Code</label>
...
<div class="form-check">
	 <input class="form-check-input" name="remark" type="checkbox" value="FEATURED" id="flexFeatured">
	 <label class="form-check-label" for="flexFeatured">FEATURED</label>
	 </div>
	 ...
	 <div class="form-check">
	 <input class="form-check-input" name="remark" type="checkbox" value="COLLECTION" id="flexRemark">
	 <label class="form-check-label" for="flexRemark">COLLECTION</label>
	 </div>
